    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.auth', verbose_name='权限组')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='users.group', verbose_name='用户组')),
            ],
            options={
                'verbose_name': '用户表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auth_permissions', to='users.auth', verbose_name='权限组')),
            ],
            options={
                'verbose_name': '权限菜单表',
